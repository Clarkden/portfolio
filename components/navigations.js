    ...
    return (
        <div className={`${navbarcolor} duration-300 z-40 sticky top-0`}>
            <nav className={`flex flex-row items-center md:items-baseline justify-between w-11/12 h-[4vh] sm-h[8vh] md:h-[10vh] mx-auto py-8 md:py-5`}>
                ...
                <div className='flex flex-row md:gap-2 transition'>
                    <div className='flex flex-row gap-2 items-center ml-2'>
                        <a target="_blank" rel="noopener norefferer" href="https://twitter.com/clarkholden5?lang=en"><FontAwesomeIcon icon={faTwitter} className='text-white hover:scale-110 hover:cursor-pointer' /></a>
                        <a target="_blank" rel="noopener noreferrer" href='https://www.instagram.com/clarkh_/'><FontAwesomeIcon icon={faInstagram} className='text-white hover:scale-110 hover:cursor-pointer' /> </a>
                    </div>
                </div>
